<template>
  <div class="product-info">
    ...
    <section class="intro">
      <div class="img">
        <img src="../../assets/images/zx9-speaker.png" alt="zx9-speaker" />
      </div>
      <div class="info">
        <h2>NEW PRODUCT</h2>
        <h1>
    ...
    <section class="features">
      ...
      <div class="right">
        ...
        <p><span>2X</span> 3.5mm 10m Audio Cable</p>
    ...
    <section class="images">
      <div class="left">
        <img
          src="../../assets/images/zx9-speaker-images-1.png"
          alt="zx9-speaker"
        />
        <img
          src="../../assets/images/zx9-speaker-images-2.png"
          alt="zx9-speaker"
        />
      </div>
      <div class="right">
        <img
          src="../../assets/images/zx9-speaker-images-3.png"
          alt="zx9-speaker"
        />
      </div>
    </section>
