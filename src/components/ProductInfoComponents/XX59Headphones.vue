<template>
  <div class="product-info">
    ...
    <section class="intro">
      <div class="img">
        <img src="../../assets/images/XX59.png" alt="xx59-headphones" />
      </div>
      <div class="info">
        <h1>
          XX59 <br />
    ...
    <section class="images">
      <div class="left">
        <img
          src="../../assets/images/XX59-images-1.png"
          alt="xx59-headphones"
        />
        <img
          src="../../assets/images/XX59-images-2.png"
          alt="xx59-headphones"
        />
      </div>
      <div class="right">
        <img
          src="../../assets/images/XX59-images-3.png"
          alt="xx59-headphones"
        />
      </div>
    </section>
